...
- [X] T082 [P] [US6] Create domain event repository implementation in `apps/finance-api/internal/events/domain_event_repository.go`
- [X] T083 [P] [US6] Create outbox repository implementation in `apps/finance-api/internal/events/outbox_repository.go`
- [X] T084 [US6] Implement domain event generation for USER_REGISTERED in `apps/finance-api/internal/auth/register_service.go`
- [X] T085 [US6] Implement domain event generation for USER_LOGGED_IN in `apps/finance-api/internal/auth/login_service.go`
- [X] T086 [US6] Implement domain event generation for USER_LOGGED_OUT in `apps/finance-api/internal/auth/login_service.go`
- [X] T087 [US6] Implement domain event generation for ACCOUNT_CREATED in `apps/finance-api/internal/accounts/account_service.go`
- [X] T088 [US6] Implement domain event generation for TRANSACTION_CREATED in `apps/finance-api/internal/transactions/transaction_service.go`
