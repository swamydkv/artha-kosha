...
- [ ] T036 [P] [US1] Create session repository implementation in `apps/finance-api/internal/sessions/session_repository.go`
- [ ] T037 [US1] Create session service with sliding expiration logic in `apps/finance-api/internal/sessions/session_service.go`
- [ ] T038 [US1] Implement GET /session handler in `apps/finance-api/internal/http/session_handler.go`
- [ ] T039 [US1] Implement DELETE /session handler in `apps/finance-api/internal/http/session_handler.go`
- [ ] T040 [US1] Implement DELETE /sessions handler in `apps/finance-api/internal/http/session_handler.go`
- [ ] T041 [US1] Update POST /login handler to create session and set HttpOnly cookie in `apps/finance-api/internal/http/auth_handlers.go`
- [ ] T042 [US1] Update POST /logout handler to revoke session and clear cookie in `apps/finance-api/internal/http/auth_handlers.go`
- [ ] T043 [US1] Implement session validation middleware in `apps/finance-api/internal/http/middleware/session.go`
- [ ] T044 [US1] Update OpenAPI spec with session endpoints in `api/auth-api.yaml`
