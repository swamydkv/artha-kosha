...
The following mockups are part of the requirements and MUST be reviewed as part of the approval process. They define the intended user experience for the MVP and make the visual structure explicit before implementation begins.
...
│ [Show / Hide password]                                      │
│ [Inline validation messages appear here]                    │
│ [Create Account]                                             │
└──────────────────────────────────────────────────────────────┘
```

**Intent**: A clean, single-column fintech-style onboarding screen with clear field grouping, inline validation, a visible primary action, and a password visibility control.
...
│ [Generic error message if credentials are invalid]           │
└──────────────────────────────────────────────────────────────┘
```

**Intent**: A simple, uncluttered sign-in experience with only the minimum fields required for secure access.

### Dashboard Mockup

```text
┌──────────────────────────────────────────────────────────────┐
│ ArthaKosha                     [Profile] [Logout]            │
├──────────────────────────────────────────────────────────────┤
│ Welcome, Swamy! 👋                                           │
│ Your personal finance workspace is ready.                    │
│ [Quick actions / overview cards / upcoming tasks]           │
└──────────────────────────────────────────────────────────────┘
```

**Intent**: A personalized, welcoming home screen that reflects the user’s identity immediately after successful authentication.
