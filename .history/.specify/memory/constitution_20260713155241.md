...
- Templates requiring updates: plan-template.md ⚠ pending (reviewed; no repo-specific placeholders were changed), spec-template.md ⚠ pending (reviewed; generic approval gates remain), tasks-template.md ⚠ pending (reviewed; test-first ordering remains generic); no runtime guidance docs were present
